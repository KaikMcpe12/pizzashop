...
import { getOrders } from '@/api/get-orderts'
...
export function Orders() {
  ...
  const { data: result } = useQuery({
    queryKey: ['orders', pageIndex, orderId, customerName, status], // dependência para indentificar que é um query diferente
    queryFn: () =>
      getOrders({
        pageIndex,
        orderId,
            ...
            <Table>
              <TableHeader>
                <TableRow>
                  ...
                  <TableHead className="w-35">Identificação</TableHead>
